...
1. swapoff -a && dd if=/dev/zero of=/swapfile bs=1M count=2048 conv=notrunc && chmod 0600 /swapfile && mkswap /swapfile && swapon /swapfile && sed -i "3iswapon /swapfile" /etc/rc.local
